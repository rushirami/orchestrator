...
- [Network access](./user/network-access.md)
- [Local diagnostics](./user/telemetry.md)
- [Customize a project icon](./user/project-settings.md)
- [Environment themes](./user/environment-theme.md)
- [Local environments](./user/remote-access.md)
...
- [Local environments](./internals/remote.md)
- [Server updates](./internals/server-updates.md)
- [Resource telemetry](./internals/resource-telemetry.md)
- [Local transport boundary](./internals/environment-auth.md)
